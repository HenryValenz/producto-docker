...
<body>
    <div class="sidebar">
        ...
        <nav class="menu">
    <ul>
        <li class="{{ request()->routeIs('form.registrar.alumno') ? 'active' : '' }}">
            <a href="{{ route('form.registrar.alumno') }}">
                <i class="fas fa-user-plus"></i>
                <span>Matricular</span>
            </a>
        </li>
        <li class="{{ request()->routeIs('matriculados.index') ? 'active' : '' }}">
        ...
        <li class="{{ request()->routeIs('registros.index') ? 'active' : '' }}">
